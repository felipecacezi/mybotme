...
export const updateCompanySchema = z.object({
  ...
  zipcode: z.string().min(8, 'O CEP deve ter 8 caracteres').optional(),
  active: z.number().int('O campo "active" deve ser um número inteiro').min(0).max(1).default(1).optional(),
});
